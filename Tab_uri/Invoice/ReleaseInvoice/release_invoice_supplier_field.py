...
class SupplierCompanyField(QDialog):
	def __init__(self):
		super().__init__()
#TODO toate datele tyrebuiesc luate din baza de date tabelul cu datele companiei
		...
		self.entry_supplier_company_name_field = QLabel("...")
		self.entry_supplier_company_name_field.setFixedSize(182,18)
		layout_main.addWidget(self.entry_supplier_company_name_field, 0, 1)
		...
		self.entry_supplier_company_cif_field = QLabel("...")
		...
		self.entry_supplier_company_reg_number_field = QLabel("...")
		self.entry_supplier_company_reg_number_field.setFixedSize(182, 18)
		layout_main.addWidget(self.entry_supplier_company_reg_number_field, 2,1)
		...
		self.entry_supplier_company_headquarter_field = QLabel("...")
		self.entry_supplier_company_headquarter_field.setFixedSize(182, 18)
		layout_main.addWidget(self.entry_supplier_company_headquarter_field, 3, 1)
		...
		self.entry_supplier_company_county_field = QLabel("...")
		self.entry_supplier_company_county_field.setFixedSize(182, 18)
		layout_main.addWidget(self.entry_supplier_company_county_field, 4, 1)
		...
		self.entry_supplier_company_iban_field = QLabel("...")
		self.entry_supplier_company_iban_field.setFixedSize(182, 18)
		layout_main.addWidget(self.entry_supplier_company_iban_field, 5, 1)
		...
		self.entry_supplier_company_social_capital_field = QLabel("...")
		self.entry_supplier_company_social_capital_field.setFixedSize(182, 18)
		layout_main.addWidget(self.entry_supplier_company_social_capital_field, 6, 1)
		...
		self.entry_supplier_company_bank_field = QLabel("...")
		self.entry_supplier_company_bank_field.setFixedSize(182, 18)
		layout_main.addWidget(self.entry_supplier_company_bank_field, 7, 1)
